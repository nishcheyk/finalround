...
export function PopoverForm({
  ...
  // Open on mouse enter (hover in)
  const handleMouseEnter = useCallback(() => {
    setOpen(true);
  }, [setOpen]);

  // Accessibility: focus first focusable element when open
  useEffect(() => {
    if (open && ref.current) {
    ...
    >
      <AnimatePresence>
        <motion.div
          ...
          className="absolute p-1 overflow-hidden bg-muted shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none rounded-xl z-50"
          ref={ref}
          style={{ width, height }}
        >
          <motion.span
          ...
          <AnimatePresence mode="popLayout">
            {showSuccess ? (
              ...
              <motion.div
                ...
                className="h-full border bg-white dark:bg-[#121212] text-black dark:text-white z-20 rounded-md"
              >
                {openChild}
              </motion.div>
            )}
  ...
  return (
    <>
      ...
      >
        ...
        />
        <path
          d="M12.1334 16.9667L15.0334 19.8667L19.8667 13.1M27.6 16C27.6 17.5234 27.3 19.0318 26.717 20.4392C26.1341 21.8465 25.2796 23.1253 24.2025 24.2025C23.1253 25.2796 21.8465 26.1341 20.4392 26.717C19.0318 27.3 17.5234 27.6 16 27.6C14.4767 27.6 12.9683 27.3 11.5609 26.717C10.1535 26.1341 8.87475 25.2796 7.79759 24.2025C6.72043 23.1253 5.86598 21.8465 5.28302 20.4392C4.70007 19.0318 4.40002 17.5234 4.40002 16C4.40002 12.9235 5.62216 9.97301 7.79759 7.79759C9.97301 5.62216 12.9235 4.40002 16 4.40002Z"
          stroke="#2090FF"
          strokeWidth="2.4"
          strokeLinecap="round"
...
// Include your PopoverFormCutOutTopIcon component below or import it if external
